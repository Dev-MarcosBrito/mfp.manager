  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4 md:gap-8">
        <Link to="/" className="flex items-center gap-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 rounded-md">
        ...
        <div className="flex items-center justify-center gap-4 md:gap-8 text-sm md:text-base">
          <NavLink
            to="/printer"
            className={({ isActive }) =>
              `hover:text-gray-300 transition-colors ${isActive ? "text-red-400" : ""}`
            }
          >
            Printer
          </NavLink>
          ...
          <div className="flex items-center justify-center gap-2">
            <button className="bg-red-600 hover:bg-red-700 px-4 py-1 rounded-full cursor-pointer text-xs md:text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500">
              Login MFP - Printer
            </button>
            <button className="bg-red-600 hover:bg-red-700 px-4 py-1 rounded-full cursor-pointer text-xs md:text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500">
              Login MFP - Assets
