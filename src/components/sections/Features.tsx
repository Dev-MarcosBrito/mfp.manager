...
const Features = () => {
    ...
    const features = [
        {
            icon: ClipboardList,
            title: t("features.items.registry.title"),
            description: t("features.items.registry.desc"),
        },
        {
            icon: MonitorSmartphone,
            title: t("features.items.monitoring.title"),
            description: t("features.items.monitoring.desc"),
        },
        {
            icon: BarChart3,
        ...
        {
            icon: Settings2,
            title: t("features.items.maintenance.title"),
            description: t("features.items.maintenance.desc"),
        },
    ];
